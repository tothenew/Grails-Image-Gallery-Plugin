    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><img src="${createLink(action:'showPhoto',controller:'photo',id:photo?.id, params:[thumbnail:'true'])}"  /></td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><img src="${createLink(action:'showPhoto',controller:'photo',id:photo?.id)}" width="100" height="100" /></td>
